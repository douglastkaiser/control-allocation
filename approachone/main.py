...
def allocate(tau_y, tau_z, thrust):
    ...
    w0 += math.sqrt(abs(thrust_quadrant_0)/2/C)*math.copysign(1, thrust_quadrant_0)
    w1 += math.sqrt(abs(thrust_quadrant_0)/2/C)*math.copysign(1, thrust_quadrant_0)
    w2 += math.sqrt(abs(thrust_quadrant_1)/2/C)*math.copysign(1, thrust_quadrant_1)
    w3 += math.sqrt(abs(thrust_quadrant_1)/2/C)*math.copysign(1, thrust_quadrant_1)
    w4 += math.sqrt(abs(thrust_quadrant_2)/2/C)*math.copysign(1, thrust_quadrant_2)
    w5 += math.sqrt(abs(thrust_quadrant_2)/2/C)*math.copysign(1, thrust_quadrant_2)
    w6 += math.sqrt(abs(thrust_quadrant_3)/2/C)*math.copysign(1, thrust_quadrant_3)
    w7 += math.sqrt(abs(thrust_quadrant_3)/2/C)*math.copysign(1, thrust_quadrant_3)
